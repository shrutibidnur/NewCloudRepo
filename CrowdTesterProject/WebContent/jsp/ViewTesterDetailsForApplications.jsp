            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                       <form:form id="viewBugs" method="post" modelAttribute="testerDetailsList" action="#">
                       <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filter">	
            <br/><br/>
            <div class="CSSTableGenerator" >
	<table width="100%" class='order-table table'>
		<tr height="70px">
			<td>TESTER FIRST NAME</td>
			<td>TESTER LAST NAME</td>
			<td> EMAIL</td>
			<td> EXPERIENCE</td>
			<td>OCCUPATION</td>
			<td>EDUCATION</td>
			...
			<c:forEach var="tester" items="${testerDetailsList}">
			<tr height="50px">
			<td><c:out value="${tester.firstName}"></c:out></td>
			<td><c:out value="${tester.lastName}"></c:out></td>
			<td><c:out value="${tester.email}"></c:out></td>
			<td><c:out value="${tester.experience}"></c:out></td>
			<td><c:out value="${tester.occupation}"></c:out></td>
			<td><c:out value="${tester.education}"></c:out></td>
			<td><c:out value="${tester.ranking}"></c:out></td>
			</tr>
			</c:forEach>
